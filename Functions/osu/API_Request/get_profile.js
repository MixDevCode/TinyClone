    ...
    try {
        ...
        if (check_type == 'bancho') {
            if (ver == 2) {
                ...
                return new Profile({
                    username: user.username, id: user.id, playcount: user.statistics.play_count,
                ...
                return new Profile({
                    username: user[0].username, id: user[0].user_id, global_rank: user[0].pp_rank,
            ...
            return new Profile({
                username: user_info.username, id: Number(user_info.id),
            ...
            return new Profile({
                username: user.username, id: Number(user.id),
            ...
            return new Profile({
                username: user.username, id: Number(user.id), playcount: Number(user[a_mode].playcount),
